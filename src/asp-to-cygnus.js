...
function translateInitialize(str){
  var hypStart = str.indexOf("(set_");
  var b = str.substring(hypStart+5);
    ...
    if (start != -1 && mid != -1){
      ...
      if (bList.length==2){ // B = bList[0], C = bList[1]
        ...
        if (typeof bList[2] == "number"){
          ps.push({"l":[bList[0]],"relation":a,"r":[bList[1]],"num":bList[2]});
        }
        else{
          ps.push({"l":[bList[0]],"relation":a,"r":[bList[1]]});
        }
    ...
    if (firstComma != -1){
      ...
      if (firstParen != -1 && lastParen != -1){
        ...
        if (fList.length==2){ // F = fList[0], G = fList[1]
          rs.push({"l":[fList[0]],"relation":e,"r":[fList[1]]});
        }
        else if (fList.length==3){
          if (typeof fList[2]=="number"){
            rs.push({"l":[fList[0]],"relation":e,"r":[fList[1]],"num":fList[2]});
          }
          else{
            rs.push({"l":[fList[0]],"relation": e,"r":[fList[1]]});
          }
